...
(function () {
	...
	L.Proj.TileLayer.TMS.Provider.providers = {
		...
		NaverMap: {
			url: 'http://onetile{s}.map.naver.net/get/167/0/0/{z}/{x}/{y}/bl_vc_bg/ol_vc_an',
			...
			variants: {
				Street: {},
				Satellite: {
					url: 'http://onetile{s}.map.naver.net/167/167/0/0/{z}/{x}/{y}/bl_st_bg/ol_st_an'
				},
				Cadastral: {
					url: 'http://onetile{s}.map.naver.net/get/167/0/0/{z}/{x}/{y}/empty/ol_bc_hb',
					options: {
						opacity: 0.75
					}
				},
				Hybrid: {
					url: 'http://onetile{s}.map.naver.net/get/167/0/0/{z}/{x}/{y}/bl_st_bg/ol_st_rd/ol_st_an'
				}
